...
Use external references when they materially affect the trace. Check current official docs, public runtime examples, mature open-source baselines, and relevant package/framework behavior when tracing architecture, control flow, data flow, or validation boundaries. If external research is not applicable, unavailable, blocked, or forbidden by the Run Mode Contract, record an explicit skip rationale.
...
## External Runtime / Architecture References
- Official docs checked: ...
- Public examples or open-source baselines checked: ...
- Package/framework behavior that affects the trace: ...
