...
Read the provided `context_packet.md`, relevant discovery reports, trace reports, implementation reports, and evaluation reports before integrating. Treat them as a map, not truth. Independently verify the claims you rely on by inspecting the source files, tests, configs, docs, or runtime references directly.
